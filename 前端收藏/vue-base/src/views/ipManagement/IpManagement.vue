<template>
  <div class="IpManagement">
    <Card>
      <ip-detail-modal ref="ipDetailModal" @on-ok="search"></ip-detail-modal>
      <row type="flex">
        <!--删除ip-->
        <i-col span="15">
        ...
        <!--</i-col>-->
        <i-col span="24">
          <Alert show-icon>橙色代表摄像头处于故障中，白色代表摄像头正常运行哦！</Alert>
